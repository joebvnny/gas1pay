package com.hlzn.payway.wxpay.protocal.pay_protocol;

import java.lang.reflect.Field;
import java.util.HashMap;
import java.util.Map;

import com.hlzn.payway.wxpay.config.WxpayConfig;
import com.hlzn.payway.wxpay.util.RandomStringGenerator;
...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,String wxKey){
        ...
        //根据API给的签名规则进行签名
        String sign = Signature.getSign(toMap(), wxKey);
