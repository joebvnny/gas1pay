...
//        	isSign = MD5.verify(preSignStr, sign, AlipayConfig.key, AlipayConfig.input_charset);
        	isSign = ALPayMD5.verify(preSignStr, sign, key, AlipayConfig.input_charset);
        }
        return isSign;
    }
    ...
    */
    private static String verifyResponse(String notify_id,String partner_param) {
        //获取远程服务器ATN结果，验证是否是支付宝服务器发来的请求

//        String partner = AlipayConfig.partner;
    	String partner = partner_param;
