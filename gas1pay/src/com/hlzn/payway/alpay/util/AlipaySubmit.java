package com.hlzn.payway.alpay.util;
...
import com.hlzn.payway.alpay.config.AlipayConfig;
import com.hlzn.payway.alpay.util.httpClient.HttpProtocolHandler;
import com.hlzn.payway.alpay.util.httpClient.HttpRequest;
import com.hlzn.payway.alpay.util.httpClient.HttpResponse;
import com.hlzn.payway.alpay.util.httpClient.HttpResultType;
...
//        	mysign = MD5.sign(prestr, AlipayConfig.key, AlipayConfig.input_charset);
           	mysign = ALPayMD5.sign(prestr, key, AlipayConfig.input_charset);
        }
        return mysign;
    }
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(String payGatewayUrl, Map<String, String> sParaTemp, String strMethod, String strButtonName, String aliKey) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp, aliKey);
        List<String> keys = new ArrayList<String>(sPara.keySet());

        StringBuffer sbHtml = new StringBuffer();

        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + payGatewayUrl
