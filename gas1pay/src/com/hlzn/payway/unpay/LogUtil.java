...
//	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger("SDK_MSG_LOG");
	...
	private final static Logger GATELOG = Logger.getLogger(LogUtil.class);
	private final static Logger GATELOG_ERROR = Logger.getLogger(LogUtil.class);
	private final static Logger GATELOG_MESSAGE = Logger.getLogger(LogUtil.class);
